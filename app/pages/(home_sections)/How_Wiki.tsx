import { geologica, lexend } from "@/app/fonts/fonts";
import Image from "next/image";

const HowWikiUI = () => {
    return (
        <div className="mt-10 px-2">
            <h1 className="text-[20px] text-slate-700 md:text-[40px] font-medium">
            ...
            <div className="p-2 flex gap-2 justify-center items-center text-center md:gap-20">
                ...
                <div className="md:w-[400px]">
                    <h2 className="flex text-start text-[65px] font-bold text-pink-200">
                        <p className={lexend.className}>
                            #1
                        </p>
                    </h2>
