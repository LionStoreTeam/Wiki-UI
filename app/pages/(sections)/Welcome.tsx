...
const Welcome = () => {
    return (
        <div className="welcome w-full px-10 flex flex-col text-center justify-center items-center">
            ...
            <button className="mt-5 py-3 px-2 font-semibold text-slate-100 bg-pink-400 rounded-md hover:bg-pink-500 transition-all ease-in duration-200 cursor-pointer">
